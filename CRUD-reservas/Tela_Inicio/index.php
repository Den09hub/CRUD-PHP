        ...
        <div class="row">
            <div class="col">
                <div class="jumbotron">
                    ...
                    <p class="lead">Este é um site para você reservar espaços compartilhados. Reserve já!</p>
                    <hr class="my-4">
                    ...
                    <a class="btn btn-primary btn-lg" href="../Sistema_Reservas/tela_reservas.php" role="button">Sistema de Reservas</a>
                </div>
            </div>
        </div>
    </div>
