        ...
        <div class="row">
            <div class="col">
                <div class="jumbotron">
                    ...
                    <p class="lead">Cadastrar-se | Pesquisar</p>
                    <hr class="my-4">
                    <p>Acesse as seguintes funções.</p>
                    <a class="btn btn-primary btn-lg" href="../Gerenciamento_User/cadastro_user.php" role="button">Cadastrar Usuário</a>
                    <a class="btn btn-primary btn-lg" href="../Gerenciamento_User/pesquisa_user.php" role="button">Pesquisar Usuários</a>
                </div>
            </div>
        </div>
    </div>
